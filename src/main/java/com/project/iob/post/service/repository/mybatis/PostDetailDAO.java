...
public interface PostDetailDAO {
	...
	// 게시글 삭제
	void deletePost(@Param("postId") Long postId, @Param("userEmail") String userEmail);
	...
	// 신고 등록
	void insertReport(@Param("targetCode") String targetCode, @Param("targetId") Long targetId,
			@Param("reporterEmail") String reporterEmail, @Param("reasonCode") String reasonCode);
	...
	// 게시글 이미지 URL 목록 조회
	List<String> getImageUrls(@Param("postId") Long postId);
}
