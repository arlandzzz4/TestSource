package com.project.iob.auth.service.impl;
...
public class AuthServiceImpl implements AuthService {
	...
	public TokenDto login(LoginRequestDto loginRequest) throws NeedRegistrationException {
    	...
    	String identifier = Provider.LOCAL.name().equals(loginRequest.providerCode()) 
    	                    ? loginRequest.email() 
    	...
    	if(rt == null) {
            if (Provider.LOCAL.name().equals(loginRequest.providerCode())) {
